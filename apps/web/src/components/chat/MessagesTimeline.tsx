...
/** Live plan step list for the expandable working row. */
...
function WorkingTimelineRow({ row }: { row: Extract<TimelineRow, { kind: "working" }> }) {
  const { isCompacting, isPreparingWorktree, workingPlan } = use(TimelineRowActivityCtx);
  ...
  const showPlan = !isPreparingWorktree && !isCompacting && hasPlan;
    ...
    <div className="border-b border-border/60 pb-2 pt-1">
      {showPlan ? (
        <button
          ...
          className="flex h-6 w-full min-w-0 cursor-pointer items-center gap-2 rounded-md px-1 text-left text-sm leading-relaxed text-muted-foreground tabular-nums transition-colors duration-150 hover:bg-accent/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring/70"
        >
        ...
        <button
          type="button"
          disabled
          className="flex h-6 w-full min-w-0 cursor-default items-baseline px-1 text-left text-sm leading-relaxed text-muted-foreground tabular-nums"
        >
          <span
